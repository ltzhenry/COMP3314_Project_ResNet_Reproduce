...
def main():
    ...
    if existing_plain_logs:
        ...
        fig = plot_paper_style_comparison(
            existing_plain_logs,
            model_type='plain',
            save_path='results/figures/plain_networks_paper_style.png',
    ...
    resnet_logs = {
        'ResNet-20': Path('results/logs/ResNet20_20251106-024420.json'),
    ...
    if existing_resnet_logs:
        ...
        fig = plot_paper_style_comparison(
            existing_resnet_logs,
            model_type='resnet',
            save_path='results/figures/resnet_paper_style.png',
    ...
    if existing_plain_logs and existing_resnet_logs:
        ...
        fig = plot_paper_style_side_by_side(
            existing_plain_logs,
            existing_resnet_logs,
            save_path='results/figures/plain_vs_resnet_paper_style.png',
            iterations_per_epoch=391,
        )
